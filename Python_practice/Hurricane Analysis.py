...
# 2
# Create a Table
def create_dic(Names, Month, Year, Max_sustained_wind, Areas_Affected, Damage, Death):
    hurricanes = {}
    num_hurrican = len(names)
    for i in range(num_hurrican):
...
hurricanes = create_dic(names, months, years, max_sustained_winds, areas_affected, damages, deaths)
#print(hurricanes)
# Create and view the hurricanes dictionary
...
#print(organize_by_year(hurricanes))
# 4
...
print(max_affected_area(count_areas(hurricanes)))
...
print(num_deaths(hurricanes))
# 7
# Rating Hurricanes by Mortality
def categorize_by_mortality(hurricanses):
    mortality_sacle = {0: 0,
                        1: 100,
                        2: 500,
                        3: 1000,
    ...
    for cane in hurricanes:
        ...
        if num_deaths == mortality_sacle[0]:
            hurricanes_by_mortality[0].append(cane)
        elif num_deaths <= mortality_sacle[1]:
            hurricanes_by_mortality[1].append(cane)
        elif num_deaths <= mortality_sacle[2]:
            hurricanes_by_mortality[2].append(cane)
        elif num_deaths <= mortality_sacle[3]:
            hurricanes_by_mortality[3].append(cane)
        elif num_deaths <= mortality_sacle[4]:
...
def categorize_by_damage(hurricanes):
    ...
    for cane in hurricanes:
        ...
        if damage == "Damages not recorded" or damage == damage_scale[0]:
